...
!(function(a, b) {
  ...
  ;(r.fn = r.prototype = {
    ...
    r.extend({
      ...
      makeArray: function(a, b) {
        var c = b || []
        return (
          a != null && (w(Object(a)) ? r.merge(c, typeof a === 'string' ? [a] : a) : h.call(c, a)),
          c
        )
      },
      ...
      (d = ga.selectors = {
        ...
        filter: {
          ...
          PSEUDO: function(a, b) {
            ...
            var e =
              d.pseudos[a] || d.setFilters[a.toLowerCase()] || ga.error('unsupported pseudo: ' + a)
            return e[u]
              ? e(b)
              : e.length > 1
              ? ((c = [a, a, '', b]),
      ...
      if (!A.test(a))
        for (; d < e; d++)
          for (c = this[d]; c && c !== b; c = c.parentNode)
            if (
              c.nodeType < 11 &&
              (g ? g.index(c) > -1 : c.nodeType === 1 && r.find.matchesSelector(c, a))
            ) {
              f.push(c)
              break
            }
  ...
  function $(a) {
    return (
      a === 'true' ||
      (a !== 'false' && (a === 'null' ? null : a === +a + '' ? +a : Y.test(a) ? JSON.parse(a) : a))
    )
  }
  function _(a, b, c) {
    var d
        ...
        if (void 0 === a) {
          if (this.length && ((e = X.get(f)), f.nodeType === 1 && !W.get(f, 'hasDataAttrs'))) {
            ...
            while (c--)
              g[c] &&
                ((d = g[c].name),
                d.indexOf('data-') === 0 && ((d = r.camelCase(d.slice(5))), _(f, d, e[d])))
  ...
  var da = function(a, b) {
    return (
      ...
      a.style.display === 'none' ||
        (a.style.display === '' && r.contains(a.ownerDocument, a) && r.css(a, 'display') === 'none')
    )
  }
  ...
  function ya(a, b, c, d, e, f) {
    ...
    if (
      (d == null && e == null
        ? ((e = c), (d = c = void 0))
        : e == null &&
          (typeof c === 'string' ? ((e = d), (d = void 0)) : ((e = d), (d = c), (c = void 0))),
      e === !1)
    )
      e = wa
    else if (!e) return a
          ...
          function(a) {
            ...
            if (
              ...
              try {
                for (; c < d; c++)
                  (b = this[c] || {}),
                    b.nodeType === 1 && (r.cleanData(na(b, !1)), (b.innerHTML = a))
                b = 0
              } catch (e) {}
            }
